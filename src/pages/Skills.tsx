      ...
      <section className="py-20 min-h-screen relative">
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <SectionHeading 
            title="My Skills" 
            highlight="Skills"
            subtitle="Here's a comprehensive overview of my technical expertise and proficiency levels across various technologies."
          />
          ...
          >
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
              <div className="lg:col-span-2">
                ...
                >
                  <h3 className="text-2xl font-bold mb-8 text-primary-400 flex items-center">
              ...
              <div className="flex flex-col gap-8">
                ...
                >
                  <div className="absolute -right-10 -top-10 w-40 h-40 bg-gradient-to-br from-primary-500/20 to-purple-500/20 rounded-full blur-xl"></div>
                  ...
                  <ul className="space-y-3">
                    ...
                    >
                      <CheckCircle className="h-5 w-5 text-green-500 mt-1 flex-shrink-0" />
                      <span>Performance optimization focus</span>
                    </motion.li>
                    <motion.li 
                      className="flex items-start gap-2"
                      initial={{ x: -20, opacity: 0 }}
                  ...
                  <img 
                    ...
                    alt="Augustin Singizimana Side Profile" 
                    className="absolute -bottom-10 -right-10 w-32 h-32 object-cover rounded-full opacity-40 glass"
                  />
                </motion.div>
              </div>
            </div>
